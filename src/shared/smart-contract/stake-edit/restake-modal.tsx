      ...
      render() {
        ...
        return (
          !unMountModalWrapper && (
            ...
            <ModalWrapper
              clickable={clickable}
              title={t("my_stake.restake.title", { bucketIndex: bucketIndex.toString() })}
              onOk={this.handleOk}
                ...
                isAvailable ? (
                  <p
                    dangerouslySetInnerHTML={{
                      __html: t("my_stake.restake.desc", { stakeTime: stakeTime.toLocaleString() })
                    }}
                  />
                ) : (
                  <p
                    dangerouslySetInnerHTML={{
                      __html: t("my_stake.restake.cannot", { stakeTime: stakeTime.toLocaleString() })
                    }}
                  />
                )
              ) : (
              ...
              <Form layout={"vertical"}>
                {isAvailable && (
                  <DurationFormItem
                    ...
                    form={form}
                    // @ts-ignore
                    onChange={(number: number) => this.setState({ currentStakeDuration: number })}
                  />
                )}
